// Shared forex data layer, used by both the Vercel serverless functions in
// this folder and the Railway server (server.js).
//
// Env vars (set these on BOTH Vercel and Railway):
